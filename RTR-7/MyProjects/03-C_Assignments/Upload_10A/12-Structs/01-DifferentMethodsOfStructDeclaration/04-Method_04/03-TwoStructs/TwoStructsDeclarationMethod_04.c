...
int main(void) 
{
    ...
    struct PshMyPoint psh_point; //Declaring a single variable of type 'struct PshMyPoint' locally...;
    struct PshMyPointProperties psh_point_properties; //declaring a single variable of type 'struct PshMyPointProperties' locally...
