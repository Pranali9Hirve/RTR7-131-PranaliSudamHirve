...
struct PshMyPoint psh_point; //Declaring a single variable of type 'struct PshMyPoint' globally...
struct PshMyPointProperties psh_point_properties; //declaring a single variable of type 'struct PshMyPointProperties' globally...
