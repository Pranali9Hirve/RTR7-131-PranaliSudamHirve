...
struct PshMyPoint
{
    int psh_x;
    int psh_y;
} psh_point; //Declaring a single variable of type 'struct PshMyPoint' globally...

//Defining Struct
struct PshMyPointProperties {
    int psh_quadrant;
    char psh_axis_location[10];
} psh_point_properties; //declaring a single variable of type 'struct PshMyPointProperties' globally...
