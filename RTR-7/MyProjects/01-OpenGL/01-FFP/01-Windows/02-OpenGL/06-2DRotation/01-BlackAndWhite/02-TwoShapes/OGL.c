...
GLfloat pshAngleTriangle = 0.0f;
GLfloat pshAngleRectangle = 0.0f;
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
    ...
    hwnd = CreateWindowEx(
        WS_EX_APPWINDOW,
        szAppName,
        TEXT("PRANALI HIRVE: RTR7-131-PranaliSudamHirve/RTR-7/MyProjects/01-OpenGL/01-FFP/01-Windows/02-OpenGL/06-2DRotation/01-BlackAndWhite/02-TwoShapes"),
...
void render() // disply
{
    ...
    glRotatef(pshAngleTriangle, 0.0f, 1.0f, 0.0f);
    ...
    glRotatef(pshAngleRectangle, 1.0f, 0.0f, 0.0f);
    glBegin(GL_QUADS);
        glColor3f(1.0f, 1.0f, 1.0f);
        glVertex3f(1.0f, 1.0f, 0.0f);
        glVertex3f(-1.0f, 1.0f, 0.0f);
...
{
    // Code
    pshAngleTriangle = pshAngleTriangle + 0.4f;
    if (pshAngleTriangle >= 360.0f)
    {
        pshAngleTriangle = 0.0f;
    }

    pshAngleRectangle = pshAngleRectangle + 0.2f;
    if (pshAngleRectangle >= 360.0f)
    {
        pshAngleRectangle = 0.0f;
    }
}
