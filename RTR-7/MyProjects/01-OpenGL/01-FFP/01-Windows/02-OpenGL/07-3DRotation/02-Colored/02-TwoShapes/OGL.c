...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
    ...
    hwnd = CreateWindowEx(
        WS_EX_APPWINDOW,
        szAppName,
        TEXT("PRANALI HIRVE: RTR7-131-PranaliSudamHirve/RTR-7/MyProjects/01-OpenGL/01-FFP/01-Windows/02-OpenGL/07-3DRotation/02-Colored/02-TwoShapes"),
...
{
    // Code
    pshAnglePyramid = pshAnglePyramid + 0.2f;
    if (pshAnglePyramid >= 360.0f)
    {
        pshAnglePyramid = 0.0f;
    }

    pshAngleCube = pshAngleCube + 0.2f;
