...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
    ...
    hwnd = CreateWindowEx(
        WS_EX_APPWINDOW,
        szAppName,
        TEXT("PRANALI HIRVE: RTR7-131-PranaliSudamHirve/RTR-7/MyProjects/01-OpenGL/01-FFP/01-Windows/02-OpenGL/07-3DRotation/01-BlackAndWhite/01-SingleShape/01-Pyramid"),
...
void render() // disply
{
    ...
    glLoadIdentity();
    glTranslatef(0.0f, 0.0f, -6.0f); // Matrix madhe value aaly ani triangle disla
