...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
    ...
    hwnd = CreateWindowEx(
        WS_EX_APPWINDOW,
        szAppName,
        TEXT("PRANALI HIRVE-RTR7-131-PranaliSudamHirve-RTR-7-MyProjects-01-OpenGL-01-FFP-01-Windows-02-OpenGL-03-BWTriangle-01-Ortho"),
...
void resize(int width, int height)
{
    ...
    if (width <= height)
    {
        glOrtho(
                -100.0f, 
                100.0f,
                -100.0f * ((GLfloat)height/(GLfloat)width), // width height cha ratio ji lahan ahe tine divide karaych
                100.0f * ((GLfloat)height/(GLfloat)width),
                -100.0f,
                100.0f); // Total 6 parameters as this is volume -> left(-100), right(100), bottom(-100), top(100), near(camera chi jawal)(-100), far(camera chi lambwali)(100)
    }
    else
    {
        glOrtho(
                ...
                100.0f * ((GLfloat)width/(GLfloat)height),
                -100.0f, // width height cha ratio ji lahan ahe tine divide karaych
                100.0f,
                -100.0f,
                100.0f);
    }
